...
FACT_CHECKERS = {
    ...
    "gd": {
        "initials": "gd",
        "name": "Gene Demby",
        "role": "NPR Lead Blogger, Code Switch",
    ...
    "sh2": {
        "initials": "sh2",
        "name": "Shirley Henry",
        "role": "NPR Deputy Washington Editor",
    ...
    "sg": {
        "initials": "sg",
        "name": "Sonari Glinton",
        "role": "NPR Reporter, Business Desk",
